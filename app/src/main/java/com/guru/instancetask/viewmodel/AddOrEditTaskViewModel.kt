...
import com.guru.instancetask.data.Checkable
import com.guru.instancetask.data.Task
import com.guru.instancetask.data.Task_
...
class AddOrEditTaskViewModel: ViewModel() {
    ...
    fun onTaskAdd() {
        ...
        navigation.scope { navHostController, lifecycleOwner, toaster ->
            toaster?.toast(
                if(editing) toaster.stringResource(R.string.task_updated_successfully) else toaster.stringResource(
